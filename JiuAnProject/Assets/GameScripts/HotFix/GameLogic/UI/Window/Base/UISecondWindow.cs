...
namespace GameLogic
{
    public abstract class UISecondWindow : UIWindow
    {
        ...
        protected const string BUTTON_ITEM1 = "ButtonItem1";
        
        #region 脚本工具生成的代码
        protected ScrollRect m_scrollRectTopBtn;
        protected TextMeshProUGUI m_textTitle;
        private Button m_btnClose;
        protected GameObject m_goContainer;
        protected override void ScriptGenerator()
        {
            m_scrollRectTopBtn = FindChildComponent<ScrollRect>("TopMenu/m_scrollRectTopBtn");
