...
namespace GameLogic
{
    public class UIWarnWidget : UIWidget
    {
        ...
        protected override void ScriptGenerator()
        {
            ...
            m_dpWarnType = FindChildComponent<TMP_Dropdown>("Top/HorizontalGroup/m_dpWarnType");
